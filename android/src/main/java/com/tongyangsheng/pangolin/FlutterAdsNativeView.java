...
public class FlutterAdsNativeView implements PlatformView, MethodChannel.MethodCallHandler {
    ...
    public FlutterAdsNativeView(Activity activity, Context context, BinaryMessenger messenger, int id) {
        mActivity = activity;
        mContext = context;
        MethodChannel methodChannel = new MethodChannel(messenger, "native_" + id);
